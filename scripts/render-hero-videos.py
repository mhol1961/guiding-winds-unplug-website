#!/usr/bin/env python3
"""Render the 4 hero video reels for Guiding Winds Unplug via fal.ai
Seedance 2.0 Pro. Pulls FAL_KEY from Mark's business-suite-portal .env,
runs all 4 scenes in parallel via ThreadPoolExecutor, downloads MP4s
to public/media/hero/.

Run from project root:
    python3 scripts/render-hero-videos.py

Costs roughly $0.80–1.20 per 8-second 1080p clip on Seedance 2.0 Pro,
so ~$4 total for the four desktop reels.
"""
...
SCENES = [
    {
        ...
        'prompt': (
            ...
            "compression. Shot on Arri Alexa LF, anamorphic 2.39:1 framing scaled to "
            "16:9. No people visible. Photorealistic, Black Tomato travel-brand "
            "cinematography, painterly color grade with warm highlights and deep teal "
            "shadows."
        ),
    },
    {
        ...
        'prompt': (
            ...
            "implied, the boat appears to drift. Shot on RED Komodo at 50mm "
            "equivalent, low contrast warm grade. No people visible. Photorealistic, "
            "editorial travel cinematography, painterly atmosphere."
        ),
    },
    {
        'name': 'hero-greece-03',
        'prompt': (
            "Wide locked-off camera at sea level looking into a Cycladic cove on a "
            ...
            "catamaran and the village behind. Shot on Arri Alexa Mini LF, 35mm "
            "equivalent, gentle teal-and-orange grade. No people visible. "
            "Photorealistic, editorial travel cinematography."
        ),
    },
    {
        'name': 'hero-deck-04',
        'prompt': (
            ...
            "lens flare across the upper-left third of the frame. Slight breeze "
            ...
            "anamorphic glass (Cooke Anamorphic /i), 65mm equivalent, rich "
            "teal-and-orange Hollywood grade. No people visible. Photorealistic, "
            "editorial travel cinematography in the Black Tomato / Cereal magazine "
            "register."
        ),
    },
]
...
def main() -> int:
    ...
    for r in ok:
        print(f"  ✓ {r['name']}  {r['size'] / 1024 / 1024:.2f} MB")
    for r in fail:
